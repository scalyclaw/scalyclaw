...
Do NOT extract: greetings, small talk, questions about your capabilities, transient requests (e.g., "translate this"), or information that is only relevant to the current conversation.

Return a JSON array. Each entry:
{
  "type": "personal" | "preference" | "project" | "person" | "decision" | "opinion" | "goal" | "fact",
